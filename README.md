...
We need to update the README.md file in the future.
I just need to say that the whole implementation is based on the implementation of gpleiss. 
The original implementation can be found here [original](https://github.com/gpleiss/efficient_densenet_pytorch) and to them, we give all the credit. 
